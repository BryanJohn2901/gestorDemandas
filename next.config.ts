...
const nextConfig: NextConfig = {
  async headers() {
    ...
    // X-Frame-Options e HSTS só em produção: em dev eles quebram o preview
    // em <iframe> de editores/ferramentas (ex.: painel de preview do VSCode),
    // que carrega localhost dentro de um iframe de origem diferente.
